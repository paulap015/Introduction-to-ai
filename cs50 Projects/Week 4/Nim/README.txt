...
VIDEO NOTE: Your video should show at least two fully AI-trained games of Nim.
...
Game #1 (and you must state the result of that game)
Game #2 (and you must state the result of that game)
As an example, your timestamps should follow this format (two examples below):
0:33 - Game #1 (AI wins)
1:24 - Game #2 (Human wins)
Submit this form.
